                                        ...
                                        <div class="login-wrap" style="background-color: #fff;">
                                           <?php while ($user=mysqli_fetch_array($user_res)) { ?>
                                            <h3 class="text-center">User Detail</h3>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12 table-form-body">
                                                            <div class="card-form">
                                                            ...
                                                            <table id="example" class="table table-striped table-bordered">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th scope="col">Sale Experience</th>
                                                                        <th scope="col">Sold Cold Calls</th>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td> <span class="card-text"><?php echo $user['name']; ?></span></td>
                                                                        <td><span class="card-text"><?php echo $user['phone']; ?></span></td>
                                                                        <td><span class="card-text"><?php echo $user['email']; ?></span></td>
                                                                        <td>
                                                                            <span>
                                            ...
                                            <table id="example" class="table table-striped table-bordered">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th scope="col">Employed Status</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <?php while ($row = mysqli_fetch_array($results)) { ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php if ($row['currently_here'] == "1") { ?>
                                                                    <span class="badge badge-primary">Presently Employed Here</span>
                                                                <?php } else { ?>
