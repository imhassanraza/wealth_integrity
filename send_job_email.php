...
$email_body = "<h2 style='color:#1d95b7;'>Job Application Form</h2>";
$email_body .= "<table border='1' style='border-collapse: collapse; width: 100%; text-align: left;'>";
$email_body .= "<tbody>";
$email_body .= "<tr><td style='font-weight: 600; color: #1d95b7;width:20%;padding: 5px;'>Name</td><td style='padding: 5px; width:30%;'>". $name ."</td>";
$email_body .= "<td style='font-weight: 600; color: #1d95b7;width:20%;padding: 5px;'>Phone Number</td><td style='padding: 5px; width:30%;'> ".$your_phone."</td></tr>";

$email_body .= "<tr><td style='font-weight: 600; color: #1d95b7;width:20%;padding: 5px;'>Email</td><td style='padding: 5px; width:30%;'>". $email ."</td>";
$email_body .= "<td style='font-weight: 600; color: #1d95b7;width:20%;padding: 5px;'>Address</td><td style='padding: 5px; width:30%;'> ".$your_address."</td></tr>";

if ($data['education_radio'] == "option1") {
    $email_body .= "<tr><td style='font-weight: 600; color: #1d95b7;width:20%;padding: 5px;'>Highest Level of Education</td><td style='padding: 5px; width:30%;'> Middle School </td>";
}elseif ($data['education_radio'] == "option2") {
    $email_body .= "<tr><td style='font-weight: 600; color: #1d95b7;width:20%;padding: 5px;'>Highest Level of Education</td><td style='padding: 5px; width:30%;'> High School </td>";
}elseif ($data['education_radio'] == "option3") {
    $email_body .= "<tr><td style='font-weight: 600; color: #1d95b7;width:20%;padding: 5px;'>Highest Level of Education</td><td style='padding: 5px; width:30%;'> Technical School </td>";
}else{
    $email_body .= "<tr><td style='font-weight: 600; color: #1d95b7;width:20%;padding: 5px;'>Highest Level of Education</td><td style='padding: 5px; width:30%;'> College </td>";
}

if ($data['degree_radio'] == "option1") {
    $email_body .= "<td style='font-weight: 600; color: #1d95b7;width:20%;padding: 5px;'>Did you graduate or earn a degree?</td><td style='padding: 5px; width:30%;'> Yes </td></tr>";
}else{
    $email_body .= "<td style='font-weight: 600; color: #1d95b7;width:20%;padding: 5px;'>Did you graduate or earn a degree?</td><td style='padding: 5px; width:30%;'> No </td></tr>";
}

$email_body .= "<tr><td style='font-weight: 600; color: #1d95b7;width:20%;padding: 5px;'>Name of School</td><td style='padding: 5px; width:30%;'>".$your_school."</td>";
$email_body .= "<td style='font-weight: 600; color: #1d95b7;width:20%;padding: 5px;'>Location</td><td style='padding: 5px; width:30%;'>".$school_location."</td></tr>";


if ($data['experience_radio'] == "option1") {
    $email_body .= "<tr><td style='font-weight: 600; color: #1d95b7;width:20%;padding: 5px;'>Do you have phone, or outside sales experience?</td><td style='padding: 5px; width:30%;'> Yes </td>";
}else{
    $email_body .= "<tr><td style='font-weight: 600; color: #1d95b7;width:20%;padding: 5px;'>Do you have phone, or outside sales experience?</td><td style='padding: 5px; width:30%;'> No </td>";
}

if ($data['call_radio'] == "option1") {
    $email_body .= "<td style='font-weight: 600; color: #1d95b7;width:20%;padding: 5px;'>Have you ever sold cold calls?</td><td style='padding: 5px; width:30%;'> Yes </td></tr>";
}else{
    $email_body .= "<td style='font-weight: 600; color: #1d95b7;width:20%;padding: 5px;'>Have you ever sold cold calls?</td><td style='padding: 5px; width:30%;'> No </td></tr>";
}

$email_body .= "</tbody></table>";

if (!empty($message)) {
    $email_body .= "<h2 style='color:#1d95b7; margin-top: 30px;'>Question</h2>";
    $email_body .= "<table border='1' style='border-collapse: collapse; width: 100%; text-align: left;'><tbody>";
    $email_body .= "<tr><td style='font-weight: 600; color: #1d95b7;width:20%;padding: 5px;'>Why do you feel you can sell cold calls on the phone with our company?</td><td style='padding: 5px; width:30%;'>".$message."</td></tr>";
    $email_body .= "</tbody></table>";
}
